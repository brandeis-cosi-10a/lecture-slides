#!/bin/bash
nbmerge 00_title.ipynb 01* > ../01_intro.ipynb
nbmerge 00_title.ipynb 02* > ../02_datatypes_expressions_variables.ipynb
nbmerge 00_title.ipynb 03* > ../03_conditionals.ipynb
nbmerge 00_title.ipynb 04* > ../04_functions.ipynb
